...
class MortyAdapter (val dataMorty: List<ResultsItem?>?) : RecyclerView.Adapter<MortyAdapter.MyViewHolder>() {
    class MyViewHolder (view: View) : RecyclerView.ViewHolder(view){
        val imgMorty= view.findViewById<ImageView>(R.id.img_morty)
        val nameMorty = view.findViewById<TextView>(R.id.item_name_Morty)
        val speciesMorty = view.findViewById<TextView>(R.id.item_spesies)
        val statusMorty = view.findViewById<TextView>(R.id.item_status)
    }
